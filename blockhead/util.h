...
#ifndef  BLOCKHEAD_UTIL_H
#define  BLOCKHEAD_UTIL_H
...
extern bool fDaemonRun;
extern boost::mutex lockLog;
...
{
    if (STD_DEBUG && !fDaemonRun)
    {
        boost::unique_lock<boost::mutex> lock(lockLog);
