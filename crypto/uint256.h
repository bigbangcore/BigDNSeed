...
#include <blockhead/stream/datastream.h>
...
public:
    ...
    void ToDataStream(blockhead::CBlockheadODataStream& os) const
    {
        os.Push(pn,sizeof(pn));
    }
    void FromDataStream(blockhead::CBlockheadIDataStream& is)
    {
        is.Pop(pn,sizeof(pn));
    }
protected:
    void BlockheadSerialize(blockhead::CBlockheadStream& s,blockhead::SaveType&)
    {
        s.Write((char *)pn, sizeof(pn));
    }
    void BlockheadSerialize(blockhead::CBlockheadStream& s,blockhead::LoadType&)
    {
        s.Read((char *)pn, sizeof(pn));
    }
    void BlockheadSerialize(blockhead::CBlockheadStream& s,std::size_t& serSize)
    {
        (void)s;
        serSize += sizeof(pn);
    }
